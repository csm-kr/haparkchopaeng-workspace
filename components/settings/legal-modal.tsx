...
const TERMS: Block[] = [
  {
    h: "제1조 (목적)",
    p: [
      '본 약관은 모두의모임(이하 "서비스")이 제공하는 4인 비공개 리서치 워크스페이스의 이용과 관련하여 회사와 회원 간의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.',
    ],
  },
  {
    h: "제2조 (이용 자격)",
...
const PRIVACY: Block[] = [
  {
    p: [
      '모두의모임(이하 "회사")은 「개인정보 보호법」 등 관련 법령을 준수하며, 이용자의 개인정보를 보호하기 위해 본 처리방침을 수립·공개합니다.',
    ],
  },
  {
    h: "1. 수집하는 항목",
